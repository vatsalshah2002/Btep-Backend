...
//		product.getCategory().
	...
	@Override
	public List<Product> getAllProduct(List<String> colors, List<String> sizes, int minPrice, int maxPrice,
			int minDiscount, String category, String sort, int pageNumber, int pageSize) {
		return productRepository.findAll();
	}
